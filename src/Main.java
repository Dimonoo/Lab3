...
public class Main extends JFrame
{
    ...
    private static Map<String, String> saltTable = new HashMap<>();
    private static Map<String, String> verifTable = new HashMap<>();
    private JTextField logArea;
    private JPasswordField pasArea;
    ...
    private static void reg(String user, String password)
    {  //функция регистрации
    ...
    private static String log(String user, String password)
    { // лог авторизации
        ...
        System.out.println("Scrambler (u)= " + srpServer.getScrambler());
        System.out.println("");
    ...
    public Main(String user, String password, String modulus_N, int generator_g, String salt, int scramblerBits, String verify)
    {   // Конструктор сервера
    ...
    public Main(String user, String password, String modulus_N, int generator_g, String salt)
    {   // Конструктор клиента
        this.modulus_N = new BigInteger(modulus_N, 16);
        this.generator_g = new BigInteger("" + generator_g, 10);
        this.multiplier_k = new BigInteger("3", 10);
    ...
    public Main(String user, String password, String modulus_N, int generator_g, int saltBits)
    ...
    private void setSessionKey(boolean server, String pubKeyString, String scram) //общий ключ (отдельно генерятся но равны,если не равны то неверная пара логин пароль)
    {
    ...
    private String getIdentityHash()
    {
    ...
    private static BigInteger setN(long number)
    {
